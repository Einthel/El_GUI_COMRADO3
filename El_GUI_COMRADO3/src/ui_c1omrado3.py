...
################################################################################
## Form generated from reading UI file 'c1omrado3.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QSize(1800, 1800))
        ...
        self.progressBar_ram.setMinimumSize(QSize(240, 20))
        self.progressBar_ram.setMaximumSize(QSize(240, 20))
        ...
        self.freeTx_ram_label = QLabel(self.Ram_frame)
        self.freeTx_ram_label.setObjectName(u"freeTx_ram_label")
        self.freeTx_ram_label.setMinimumSize(QSize(0, 20))
        self.freeTx_ram_label.setMaximumSize(QSize(16777215, 20))
        self.freeTx_ram_label.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.lable_GB_ram.addWidget(self.freeTx_ram_label)
...
"border-color: rgb(0, 34, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.freeTx_ram_label.setText(QCoreApplication.translate("MainWindow", u"free_text", None))
