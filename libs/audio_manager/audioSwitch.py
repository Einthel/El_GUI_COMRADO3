...
# Строим абсолютный путь к DLL, находящейся в той же директории, что и этот скрипт
dll_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "AudioDLL.dll")
audioDll = ctypes.CDLL(dll_path)
