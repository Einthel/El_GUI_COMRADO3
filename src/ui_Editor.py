...
class Ui_Editor_Window(object):
    def setupUi(self, Editor_Window):
        ...
        self.verticalLayoutWidget.setGeometry(QRect(516, 10, 294, 362))
        ...
        self.layoutWidget.setGeometry(QRect(9, 369, 788, 332))
        self.horizontalLayout_8 = QHBoxLayout(self.layoutWidget)
        self.horizontalLayout_8.setObjectName(u"horizontalLayout_8")
        self.horizontalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.Edit_Button_groupBox = QGroupBox(self.layoutWidget)
        ...
        self.verticalLayout_3.addWidget(self.Edit_keySequenceEdit)
        ...
        self.widget = QWidget(self.Action_tab)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(5, 5, 291, 71))
        self.Action_layout = QVBoxLayout(self.widget)
        ...
        self.Choose_action_label = QLabel(self.widget)
        self.Choose_action_label.setObjectName(u"Choose_action_label")

        self.Action_layout.addWidget(self.Choose_action_label, 0, Qt.AlignmentFlag.AlignHCenter)

        self.Action_comboBox = QComboBox(self.widget)
        self.Action_comboBox.setObjectName(u"Action_comboBox")

        self.Action_layout.addWidget(self.Action_comboBox)
        ...
        self.Button_example_layout = QFrame(self.layoutWidget)
