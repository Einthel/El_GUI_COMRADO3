...
from PySide6.QtWidgets import (QApplication, QFrame, QHBoxLayout, QLabel,
    QLayout, QProgressBar, QSizePolicy, QSpacerItem,
...
class Ui_Music_player(object):
    def setupUi(self, Music_player):
        ...
        Music_player.setMaximumSize(QSize(710, 570))
        ...
        self.Music_frame = QFrame(Music_player)
        ...
        self.Music_frame.setMinimumSize(QSize(345, 560))
        self.Music_frame.setMaximumSize(QSize(345, 560))
        ...
        self.horizontalLayout.addWidget(self.Music_frame)

        self.PlayList_frame = QFrame(Music_player)
        ...
        self.PlayList_frame.setMinimumSize(QSize(345, 560))
        self.PlayList_frame.setMaximumSize(QSize(345, 560))
        self.PlayList_frame.setFrameShape(QFrame.Shape.StyledPanel)

        self.horizontalLayout.addWidget(self.PlayList_frame)
